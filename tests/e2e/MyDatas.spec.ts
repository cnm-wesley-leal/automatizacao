...
import { logingUserTestWebUser, logingUserTestAdvitiser } from '../support/Access.page';
...
test.describe('WebUser', () => {
  ...
  test('Layout', async ({ page }) => {
    ...
    test('Telefone em branco', async ({ page }) => {
      const contactSection = page.getByRole('article').filter({
        has: page.getByRole('heading', { name: 'Contato' }),
      });
    ...
    test('Formato de telefone inválido', async ({ page }) => {
